...
Output: {'step': 'observe', 'output': 'The accuracy of this answer is below 50% because MI is at third place and Gujrat Titans is at first first, so most likely the winner is GT' }
Output: {'step': 'plan', 'content': 'Since the accuracy of the answer is not correct, I have to do the complete process again to get the more accurate answer' }
